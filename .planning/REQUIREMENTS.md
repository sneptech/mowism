...
- [x] **AUTO-01**: `/mow:auto` command starts full pipeline from specified phase through milestone end
- [x] **AUTO-02**: Cross-phase transition automatically invokes next phase's lifecycle when current phase completes
- [x] **AUTO-03**: DAG-aware auto-advance only starts phases whose dependencies are satisfied
- [x] **AUTO-04**: Auto-advance pauses at discuss-phase for user input and resumes after CONTEXT.md created
- [x] **AUTO-05**: Auto-advance stops at milestone boundary and clears `workflow.auto_advance` config
- [x] **AUTO-06**: `/mow:auto` accepts optional phase range (from/to) for partial pipeline execution
