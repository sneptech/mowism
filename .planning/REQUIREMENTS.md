...
- [ ] **WKT-02**: WorktreeCreate hook copies `.planning/` directory and initializes STATUS.md in new worktrees
- [ ] **WKT-03**: WorktreeRemove hook removes manifest entry, releases phase claim, and clears dashboard state
