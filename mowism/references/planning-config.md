...
| `git.phase_branch_template` | `"mow/phase-{phase}-{slug}"` | Branch template for phase strategy |
| `git.milestone_branch_template` | `"mow/{milestone}-{slug}"` | Branch template for milestone strategy |
</config_schema>
...
**Note:** Most MOW operations use direct file reads or explicit paths, which work regardless of gitignore status.
...
- Standard MOW behavior

**When `git.branching_strategy: "phase"`:**
- `execute-phase` creates/switches to a branch before execution
- Branch name from `phase_branch_template` (e.g., `mow/phase-03-authentication`)
...
- Branch name from `milestone_branch_template` (e.g., `mow/v1.0-mvp`)
