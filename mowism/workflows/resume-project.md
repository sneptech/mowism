...
<required_reading>
@~/.claude/mowism/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node ~/.claude/mowism/bin/mow-tools.cjs init resume)
```
...
**If `planning_exists` is false:** This is a new project - route to /mow:new-project
</step>
...
📋 [N] pending todos — /mow:check-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/mow:execute-phase {phase})
   OR
1. Discuss Phase 3 context (/mow:discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/mow:plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/mow:discuss-phase [N]` — gather context first
  - `/mow:research-phase [N]` — investigate unknowns
