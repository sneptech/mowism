...
- File reference: `/mow:new-project --auto @prd.md`
...
Usage:
  /mow:new-project --auto @your-idea.md
  /mow:new-project --auto [paste or write your idea here]
...
```bash
INIT=$(node ~/.claude/mowism/bin/mow-tools.cjs init new-project)
```
...
- options:
  - "Map codebase first" — Run /mow:map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `/mow:map-codebase` first, then return to `/mow:new-project`
```
Exit command.
...
```bash
mkdir -p .planning
node ~/.claude/mowism/bin/mow-tools.cjs commit "chore: add project config" --files .planning/config.json
```
...
```bash
mkdir -p .planning
node ~/.claude/mowism/bin/mow-tools.cjs commit "docs: initialize project" --files .planning/PROJECT.md
```
...
**Check for global defaults** at `~/.mowism/defaults.json`. If the file exists, offer to use saved defaults:

```
AskUserQuestion([
  {
    question: "Use your saved default settings? (from ~/.mowism/defaults.json)",
    header: "Defaults",
    multiSelect: false,
    options: [
...
If "Yes": read `~/.mowism/defaults.json`, use those values for config.json, and skip directly to **Commit config.json** below.

If "No" or `~/.mowism/defaults.json` doesn't exist: proceed with the questions below.
...
**Note:** Run `/mow:settings` anytime to update these preferences.
...
Spawn 4 parallel mow-project-researcher agents with rich context:

```
Task(prompt="First, read ~/.claude/agents/mow-project-researcher.md for your role and instructions.
...
Use template: ~/.claude/mowism/templates/research-project/STACK.md
</output>
...
Use template: ~/.claude/mowism/templates/research-project/FEATURES.md
</output>
...
Use template: ~/.claude/mowism/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ~/.claude/mowism/templates/research-project/PITFALLS.md
</output>
...
Use template: ~/.claude/mowism/templates/research-project/SUMMARY.md
Commit after writing.
</output>
", subagent_type="mow-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```

Display research complete banner and key findings:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 MOW ▶ RESEARCH COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
node ~/.claude/mowism/bin/mow-tools.cjs commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 MOW ▶ CREATING ROADMAP
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

◆ Spawning roadmapper...
```

Spawn mow-roadmapper agent with context:
...
", subagent_type="mow-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="mow-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
```bash
node ~/.claude/mowism/bin/mow-tools.cjs commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
...
Exit skill and invoke SlashCommand("/mow:discuss-phase 1 --auto")
...
/mow:discuss-phase 1 — gather context and clarify approach
...
**Also available:**
- /mow:plan-phase 1 — skip discussion, plan directly
...
- [ ] mow-roadmapper spawned with context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases, requirement mappings, success criteria
- [ ] STATE.md initialized
- [ ] REQUIREMENTS.md traceability updated
- [ ] User knows next step is `/mow:discuss-phase 1`
