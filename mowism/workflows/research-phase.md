<purpose>
Research how to implement a phase. Spawns mow-phase-researcher with phase context.

Standalone research command. For most workflows, use `/mow:plan-phase` which integrates research automatically.
</purpose>
