...
Use mow-tools to extract must_haves from each PLAN:
...
Use mow-tools for artifact verification against must_haves in each PLAN:
...
Use mow-tools for key link verification against must_haves in each PLAN:
