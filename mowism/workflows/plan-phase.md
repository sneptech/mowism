<purpose>
Create executable phase prompts (PLAN.md files) for a roadmap phase with integrated research and verification. Default flow: Research (if needed) -> Plan -> Verify -> Done. Orchestrates mow-phase-researcher, mow-planner, and mow-plan-checker agents with a revision loop (max 3 iterations).
</purpose>
...
**If `planning_exists` is false:** Error — run `/mow:new-project` first.
...
If "Run discuss-phase first": Display `/mow:discuss-phase {X}` and exit workflow.
...
<phase_context>
IMPORTANT: If CONTEXT.md exists below, it contains user decisions from /mow:discuss-phase.
...
## 8. Spawn mow-planner Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 MOW ▶ PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
**Phase Context:**
IMPORTANT: If context exists below, it contains USER DECISIONS from /mow:discuss-phase.
...
<downstream_consumer>
Output consumed by /mow:execute-phase. Plans need:
...
## 10. Spawn mow-plan-checker Agent
...
```
Task(
  prompt="Run /mow:execute-phase ${PHASE} --auto",
  subagent_type="general-purpose",
...
- **PHASE COMPLETE** → Display final summary:
  ```
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   MOW ▶ PHASE ${PHASE} COMPLETE ✓
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  Auto-advance pipeline finished.

  Next: /mow:discuss-phase ${NEXT_PHASE} --auto
  ```
...
- /mow:plan-phase {X} --research — re-research first
...
- [ ] mow-phase-researcher spawned with CONTEXT.md
- [ ] Existing plans checked
- [ ] mow-planner spawned with CONTEXT.md + RESEARCH.md
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] mow-plan-checker spawned with CONTEXT.md
