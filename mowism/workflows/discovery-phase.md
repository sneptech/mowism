...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /mow:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/mow:discuss-phase [current-phase])
2. Create phase plan (/mow:plan-phase [current-phase])
