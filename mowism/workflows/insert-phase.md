...
Example: `/mow:insert-phase 72 Fix critical auth bug`
-> after = 72
...
Usage: /mow:insert-phase <after> <description>
Example: /mow:insert-phase 72 Fix critical auth bug
```
...
- Don't use this for planned work at end of milestone (use /mow:add-phase)
- Don't insert before Phase 1 (decimal 0.1 makes no sense)
- Don't renumber existing phases
- Don't modify the target phase content
- Don't create plans yet (that's /mow:plan-phase)
...
- [ ] `mow-tools phase insert` executed successfully
