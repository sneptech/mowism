---
name: mow:research-phase
description: Research how to implement a phase (standalone - usually use /mow:plan-phase instead)
argument-hint: "[phase]"
allowed-tools:
  - Read
  - Bash
...
**Note:** This is a standalone research command. For most workflows, use `/mow:plan-phase` which integrates research automatically.
...
## 4. Spawn mow-phase-researcher Agent
...
<downstream_consumer>
Your RESEARCH.md will be loaded by `/mow:plan-phase` which uses specific sections:
...
- [ ] mow-phase-researcher spawned with context
