...
**Orchestrator role:** Gather symptoms, spawn mow-debugger agent, handle checkpoints, spawn continuations.
...
- Offer options:
  ...
  - "Plan fix" - suggest /mow:plan-phase --gaps
  - "Manual fix" - done
...
- [ ] mow-debugger spawned with context
